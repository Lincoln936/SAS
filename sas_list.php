        ...
        <div id="imagen_central">
            ...
            <div class="situacion">
                <h1 id="titulo_pagina" class="etiquetas_campos">
                    <a name="contenido_principal">Listado imágenes subidas</a>
                </h1>
            </div>
            <div style="padding-top:1%; padding-bottom:2%; width:99%; text-align:justify;">
                ...
                <div style="margin-left: 2%;  width: 90%;">
                    <div class="situacion">
                        <h1 id="titulo_pagina" class="etiquetas_campos">
                            <a name="contenido_principal">Número de imágenes subidas</a>
                        </h1>
                    </div>
                    <br/>
                    <?php
                    $total_imagenes = count(glob("../../img/{*.jpg,*.gif,*.png}", GLOB_BRACE));
                    echo $total_imagenes;
                    ?>
                </div>
                <br />
